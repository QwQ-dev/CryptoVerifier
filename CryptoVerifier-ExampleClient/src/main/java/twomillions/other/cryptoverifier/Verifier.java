...
import twomillions.other.cryptoverifier.latency.LatencyMeasurement;
import twomillions.other.cryptoverifier.util.TimeUtils;
...
public class Verifier {
    ...
    public void verify() {
        ...
        try {
            ...
            System.out.println("无网络! 停止验证!");
            // TODO: 处理无网络情况
        } catch (SocketException exception) {
            System.out.println("无法连接至验证服务器! 请检查网络连接状态!");
            // TODO: 处理连接服务器或接受数据超时情况
        } catch (Exception exception) {
            System.out.println("验证时出错, 许可证是否正确?");
            // TODO: 处理其他可能存在的异常
        }
    }
    ...
    private void handleRequestDataError() {
        // TODO: 服务器发送的内容无法被转换成 RequestData 对象时的处理
    }
