...
public class Client {
     ...
     * TODO: 您需要更改路径
     */
    private static final String filePath = "D:/Main/桌面/Obf/native-obf/clientFiles";
    ...
    private static void startVerifyThread() {
        Runnable runnable = () -> {
            ...
            try {
                ...
                // TODO: 通常不应该发生异常，这可能是获取 Hwid 或读取文件出现错误，请处理这种情况，建议打印堆栈跟踪后退出程序
            }
        };
